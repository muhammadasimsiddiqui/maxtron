    ...
    <div class="sidebar-nav">
        ...
        <ul class="metismenu" id="sidenav">
          <li>
            ...
            <ul>
              <li><a href="index"><i class="material-icons-outlined">arrow_right</i>Analysis</a>
              </li>
              <li><a href="index2"><i class="material-icons-outlined">arrow_right</i>eCommerce</a>
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul>
              ...
              <li><a href="widgets-static"><i class="material-icons-outlined">arrow_right</i>Static</a>
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul>
              <li><a href="app-emailbox"><i class="material-icons-outlined">arrow_right</i>Email Box</a>
              </li>
              <li><a href="app-emailread"><i class="material-icons-outlined">arrow_right</i>Email Read</a>
              </li>
              <li><a href="app-chat-box"><i class="material-icons-outlined">arrow_right</i>Chat</a>
              </li>
