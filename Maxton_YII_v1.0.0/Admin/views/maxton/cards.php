...
<?php echo $this->render('partials/menu'); ?>
  ...
  <main class="main-wrapper">
    ...
    <!--breadcrumb-->
      <?php echo $this->render('partials/page-title', array( 'title' => 'Components', 'pagetitle' => 'Cards')); ?>
		<!--end breadcrumb-->
                  ...
                  <div class="col">
                    <div class="card shadow-none bg-grd-danger mb-0" style="height: 160px;">
                      <div class="card-body">
                        ...
                        <img src="https://placehold.co/400x300/png" class="position-absolute end-0 bottom-0 m-2" width="160"
                          alt="">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col">
                    <div class="card shadow-none bg-grd-warning mb-0" style="height: 160px;">
                      <div class="card-body">
                        ...
                        <img src="https://placehold.co/400x300/png" class="position-absolute end-0 bottom-0 m-2" width="200"
                          alt="">
                      </div>
                    </div>
                  </div>
