...
<?= $this->include('partials/menu') ?>
  ...
  <main class="main-wrapper">
    ...
    <!--breadcrumb-->
	  <?php echo view('partials/page-title', array('title' => 'Components', 'breadcrumb' => 'Media')); ?>
	<!--end breadcrumb-->
				...
				<div class="card radius-10 rounded-4">
					<div class="card-body">
						<div class="d-flex align-items-center">
							<img src="https://placehold.co/110x110/png" class="rounded-circle p-1 border bg-grd-primary" width="90" height="90" alt="...">
					...
					<div class="card radius-10 rounded-4">
						<div class="card-body">
							<div class="d-flex flex-row-reverse align-items-center">
								<img src="https://placehold.co/110x110/png" class="rounded-circle p-1 border bg-grd-warning" width="90" height="90" alt="...">
								<div class="flex-grow-1 ms-3">
									<h5 class="mt-0">Media heading</h5>
									<p class="mb-0">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla</p>
								</div>
		...
		<hr>
					<div class="card radius-10 rounded-4">
						<div class="card-body">
							<div class="d-flex align-items-center">
								<img src="https://placehold.co/110x110/png" class="rounded-circle p-1 border bg-grd-danger" width="90" height="90" alt="...">
								<div class="flex-grow-1 ms-3">
									<h5 class="mt-0">Media heading</h5>
									<p class="mb-0">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla</p>
								</div>
		...
		<hr>
					<div class="card radius-10 rounded-4">
						<div class="card-body">
							<div class="d-flex flex-row-reverse align-items-center">
								<img src="https://placehold.co/110x110/png" class="rounded-circle p-1 border bg-grd-success" width="90" height="90" alt="...">
								<div class="flex-grow-1 ms-3">
									<h5 class="mt-0">Media heading</h5>
									<p class="mb-0">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla</p>
								</div>
		...
		<hr>
					<div class="card radius-10 rounded-4 bg-grd-primary">
						<div class="card-body">
							<div class="d-flex align-items-center">
								<img src="https://placehold.co/110x110/png" class="rounded-circle p-1 border bg-white" width="90" height="90" alt="...">
								<div class="flex-grow-1 ms-3">
									<h5 class="mt-0">Media heading</h5>
									<p class="mb-0">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla</p>
								</div>
		...
		<hr>
						...
						<div class="card radius-10 rounded-4">
							<div class="card-body">
								<div class="d-flex align-items-center">
									<img src="https://placehold.co/110x110/png" class="rounded-circle p-1 border bg-success" width="90" height="90" alt="...">
									<div class="flex-grow-1 ms-3">
										<h5 class="mt-0">Media heading</h5>
										...
										<div class="d-flex align-items-center mt-3">
											<a class="mr-3" href="#">
												<img src="https://placehold.co/110x110/png" class=" rounded-circle p-1 border bg-info" width="90" height="90" alt="...">
											</a>
											<div class="flex-grow-1 ms-3">
												<h5 class="mt-0">Media heading</h5>
						...
						<div class="card radius-10 rounded-4">
							<div class="card-body">
								<div class="d-flex align-items-center">
									<img src="https://placehold.co/110x110/png" class="align-self-start rounded-circle p-1 border bg-danger" width="90" height="90" alt="...">
									<div class="flex-grow-1 ms-3">
								...
								<hr>
								<div class="d-flex align-items-center">
									<img src="https://placehold.co/110x110/png" class="align-self-center rounded-circle p-1 border bg-primary" width="90" height="90" alt="...">
									<div class="flex-grow-1 ms-3">
								...
								<hr>
								<div class="d-flex align-items-center">
									<img src="https://placehold.co/110x110/png" class="align-self-end rounded-circle p-1 border bg-white" width="90" height="90" alt="...">
									<div class="flex-grow-1 ms-3">
								...
								<div class="d-flex align-items-center">
									<div class="flex-grow-1 ms-3">
										...
										Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla</div>
									<img src="https://placehold.co/110x110/png" class="ml-3 rounded-circle p-1 border" width="90" height="90" alt="...">
								</div>
							</div>
						</div>
							...
							<div class="card-body">
								<ul class="list-unstyled">
									<li class="d-flex align-items-center border-bottom pb-2">
										<img src="https://placehold.co/110x110/png" class="rounded-circle p-1 border" width="90" height="90" alt="...">
										<div class="flex-grow-1 ms-3">
