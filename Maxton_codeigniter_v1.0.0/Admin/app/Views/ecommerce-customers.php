...
<?= $this->include('partials/menu') ?>
  ...
  <main class="main-wrapper">
    ...
    <!--breadcrumb-->
      <?php echo view('partials/page-title', array('title' => 'eCommerce', 'breadcrumb' => 'Customers')); ?>
		<!--end breadcrumb-->
                       ...
                       <td>
                        <a class="d-flex align-items-center gap-3" href="javascript:;">
                          <div class="customer-pic">
                            <img src="https://placehold.co/110x110/png" class="rounded-circle" width="40" height="40" alt="">
                          </div>
