...
<?= $this->include('partials/menu') ?>
  ...
  <main class="main-wrapper">
    ...
    <!--breadcrumb-->
      <?php echo view('partials/page-title', array('title' => 'eCommerce', 'breadcrumb' => 'Customer Details')); ?>
    <!--end breadcrumb-->
                    ...
                    <td>
                      <div class="d-flex align-items-center gap-3">
                        <div class="product-box">
                          <img src="https://placehold.co/200x200/png" width="55" class="rounded-3" alt="">
                        </div>
