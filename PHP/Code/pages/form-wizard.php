        ...
        <form onSubmit="return false">
              ...
              <div class="col-12">
                <div class="d-flex align-items-center gap-3">
                  <button class="btn btn-grd-danger px-4" onclick="stepper2.previous()"><i
                      class='bx bx-left-arrow-alt me-2'></i>Previous</button>
                  <button class="btn btn-grd-success px-4" onclick="stepper2.next()">Next<i
                      class='bx bx-right-arrow-alt ms-2'></i></button>
                </div>
              </div>
            </div><!---end row-->
          ...
          <div id="test-nl-4" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper2trigger4">
            ...
            <div class="row g-3">
              ...
              <div class="col-12">
                <div class="d-flex align-items-center gap-3">
                  <button class="btn btn-grd-primary px-4" onclick="stepper2.previous()"><i
                      class='bx bx-left-arrow-alt me-2'></i>Previous</button>
        ...
        <form onSubmit="return false">
          ...
          <div id="test-vl-2" class="bs-stepper-pane content fade" aria-labelledby="stepper3trigger2">
            ...
            <div class="row g-3">
              ...
              <div class="col-12">
                <div class="d-flex align-items-center gap-3">
                  <button class="btn btn-outline-secondary px-4" onclick="stepper3.previous()"><i
                      class='bx bx-left-arrow-alt me-2'></i>Previous</button>
                  <button class="btn btn-grd-primary px-4" onclick="stepper3.next()">Next<i
                      class='bx bx-right-arrow-alt ms-2'></i></button>
                </div>
          ...
          <div id="test-vl-4" class="bs-stepper-pane content fade" aria-labelledby="stepper3trigger4">
            ...
            <div class="row g-3">
              ...
              <div class="col-12">
                <div class="d-flex align-items-center gap-3">
                  <button class="btn btn-grd-primary px-4" onclick="stepper3.previous()"><i
                      class='bx bx-left-arrow-alt me-2'></i>Previous</button>
