      ...
      <div class="card-body">
        ...
        <div class="fm-menu">
          <div class="list-group list-group-flush"> <a href="javascript:;" class="list-group-item py-1"><i
            ...
            <a href="javascript:;" class="list-group-item py-1"><i class='bx bx-trash-alt me-2'></i><span>Deleted
                Files</span></a>
          ...
          <div class="col-12 col-lg-4">
            <div class="card shadow-none border rounded-4">
              <div class="card-body">
                ...
                <div class="progress" style="height: 7px;">
                  <div class="progress-bar bg-danger bg-grd-deep-blue" role="progressbar" style="width: 45%;"
          ...
          <div class="col-12 col-lg-4">
            <div class="card shadow-none border rounded-4">
              <div class="card-body">
                ...
                <div class="progress" style="height: 7px;">
                  <div class="progress-bar bg-grd-danger" role="progressbar" style="width: 65%;" aria-valuenow="65"
                    aria-valuemin="0" aria-valuemax="100"></div>
                </div>
              </div>
            </div>
              ...
              <div class="card-body">
                <div class="d-flex align-items-center">
                  ...
                  <div class="user-groups ms-auto">
                    <img src="https://placehold.co/110x110/png" width="35" height="35" class="rounded-circle" alt="" />
                    <img src="https://placehold.co/110x110/png" width="35" height="35" class="rounded-circle" alt="" />
                  </div>
