  ...
  <div class="col">
    <div class="card rounded-4">
      <div class="card-body">
        ...
        <div class="mt-4">
          <p class="mb-2 d-flex align-items-center justify-content-between">285 left to Goal<span class="">68%</span>
          </p>
  ...
  <div class="col">
    <div class="card rounded-4">
      <div class="card-body">
        ...
        <div class="mt-4">
          <p class="mb-2 d-flex align-items-center justify-content-between">285 left to Goal<span class="">78%</span>
          </p>
          <div class="progress w-100" style="height: 6px;">
  ...
  <div class="col">
    <div class="card rounded-4">
      <div class="card-body">
        ...
        <div class="mt-4">
          <p class="mb-2 d-flex align-items-center justify-content-between">285 left to Goal<span class="">88%</span>
          </p>
          <div class="progress w-100" style="height: 6px;">
