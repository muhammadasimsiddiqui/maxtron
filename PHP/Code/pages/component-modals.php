                          ...
                          <div class="card-body">
                            ...
                            <div class="d-flex align-items-center gap-3">
                              <a class="d-block flex-shrink-0" href="javascript:;">
                                <img src="https://placehold.co/200x200/png" class="rounded-3" width="60" height="60"
                                  alt="Product">
                              </a>
                              <div class="ps-2">
          ...
          <div class="modal fade" id="FullScreenModal">
            <div class="modal-dialog modal-fullscreen">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="row row-cols-1 row-cols-lg-4">
                    <div class="col">
                      <div class="card rounded-4">
                        <div class="card-body">
                          <img src="https://placehold.co/800x500/png" class="img-fluid rounded-4" alt="">
                          <div class="mt-3">
                ...
                <div class="modal-footer border-top-0">
                  <button type="button" class="btn btn-grd-danger rounded-0" data-bs-dismiss="modal">Delete</button>
