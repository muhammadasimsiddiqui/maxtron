    ...
    <div class="email-sidebar-content">
      <div class="email-navigation">
        <div class="list-group list-group-flush">
          <a href="app-emailbox" class="list-group-item active d-flex align-items-center"><i
          ...
          <div class="list-group-item email-hangout cursor-pointer border-top">
            <div class="d-flex align-items-center gap-3">
              <div class="chat-user-online">
                <img src="https://placehold.co/110x110/png" width="42" height="42" class="rounded-circle" alt="" />
              </div>
              <div class="flex-grow-1">
                <p class="mb-0">Jessica Doe</p>
              </div>
              <div class="dropdown">
                <div class="font-24 dropdown-toggle dropdown-toggle-nocaret" data-bs-toggle="dropdown"><i
                    class='bx bx-plus'></i>
                </div>
  ...
  <div class="email-content">
    <div class="email-read-box p-3">
      ...
      <div class="email-read-content px-md-5 py-5">
        ...
        <p>consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical literature,
