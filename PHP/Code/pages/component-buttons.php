    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="row row-cols-auto g-3">
          ...
          <hr class="w-100">
          <div class="col">
            <button type="button" class="btn btn-primary btn-circle raised rounded-circle d-flex gap-2 wh-48"><i
                class="material-icons-outlined">lock_open</i></button>
          </div>
          <div class="col">
            <button type="button" class="btn btn-danger btn-circle raised rounded-circle d-flex gap-2 wh-48"><i
                class="material-icons-outlined">chat_bubble_outline</i></button>
          </div>
          <div class="col">
            <button type="button" class="btn btn-success btn-circle raised rounded-circle d-flex gap-2 wh-48"><i
                class="material-icons-outlined">call</i></button>
          </div>
          <div class="col">
            <button type="button" class="btn btn-info btn-circle raised rounded-circle d-flex gap-2 wh-48"><i
                class="material-icons-outlined">location_on</i></button>
          </div>
          <div class="col">
            <button type="button" class="btn btn-warning btn-circle raised rounded-circle d-flex gap-2 wh-48"><i
                class="material-icons-outlined">send</i></button>
          </div>
          <div class="col">
            <button type="button" class="btn btn-dark btn-circle raised rounded-circle d-flex gap-2 wh-48"><i
                class="material-icons-outlined">clear</i></button>
          </div>
          <div class="col">
            <button type="button" class="btn btn-secondary btn-circle raised rounded-circle d-flex gap-2 wh-48"><i
                class="material-icons-outlined">push_pin</i></button>
          </div>
          <div class="col">
            <button type="button" class="btn btn-light btn-circle raised rounded-circle d-flex gap-2 wh-48"><i
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="row row-cols-auto g-3">
          ...
          <hr class="w-100">
          <div class="col">
            <button type="button" class="btn btn-outline-primary btn-circle rounded-circle d-flex gap-2 wh-48"><i
                class="material-icons-outlined">lock_open</i></button>
          </div>
          <div class="col">
            <button type="button" class="btn btn-outline-danger btn-circle rounded-circle d-flex gap-2 wh-48"><i
                class="material-icons-outlined">chat_bubble_outline</i></button>
          </div>
          <div class="col">
            <button type="button" class="btn btn-outline-success btn-circle rounded-circle d-flex gap-2 wh-48"><i
                class="material-icons-outlined">call</i></button>
          </div>
          <div class="col">
            <button type="button" class="btn btn-outline-info btn-circle rounded-circle d-flex gap-2 wh-48"><i
                class="material-icons-outlined">location_on</i></button>
          </div>
          <div class="col">
            <button type="button" class="btn btn-outline-warning btn-circle rounded-circle d-flex gap-2 wh-48"><i
                class="material-icons-outlined">send</i></button>
          </div>
          <div class="col">
            <button type="button" class="btn btn-outline-dark btn-circle rounded-circle d-flex gap-2 wh-48"><i
                class="material-icons-outlined">clear</i></button>
          </div>
          <div class="col">
            <button type="button" class="btn btn-outline-secondary btn-circle rounded-circle d-flex gap-2 wh-48"><i
                class="material-icons-outlined">push_pin</i></button>
          </div>
          <div class="col">
            <button type="button" class="btn btn-outline-light btn-circle rounded-circle d-flex gap-2 wh-48"><i
                class="material-icons-outlined">archive</i></button>
          </div>
        </div>
      </div>
