        ...
        <div class="col-md-8">
          <div class="card-body">
            ...
            <div class="mt-4 d-flex align-items-center justify-content-between">
              <button class="btn btn-light d-flex gap-2 px-3"><i class="material-icons-outlined">shopping_basket</i>Add
                to Cart</button>
          ...
          <div class="col">
            <div class="card shadow-none bg-voilet mb-0" style="height: 160px;">
              <div class="card-body">
                ...
                <img src="assets/images/cat/01.png"
          ...
          <div class="col">
            <div class="card shadow-none bg-success mb-0" style="height: 160px;">
              <div class="card-body">
                ...
                <img src="assets/images/cat/02.png"
          ...
          <div class="col">
            <div class="card shadow-none bg-dark-blue mb-0" style="height: 160px;">
              <div class="card-body">
                ...
                <img src="assets/images/cat/03.png"
          ...
          <div class="col">
            <div class="card shadow-none bg-danger mb-0" style="height: 160px;">
              <div class="card-body">
                ...
                <img src="assets/images/cat/04.png"
          ...
          <div class="col">
            <div class="card shadow-none bg-indigo mb-0" style="height: 160px;">
              <div class="card-body">
                ...
                <img src="assets/images/cat/06.png"
