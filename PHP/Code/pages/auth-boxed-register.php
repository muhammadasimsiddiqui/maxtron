          ...
          <div class="row gy-2 gx-0 my-4">
            <div class="col-12 col-lg-12">
              <button
                ...
                <span class=""><img src="assets/images/apps/05.png" width="20" class="me-2"
            ...
            <div class="col-12 col-lg-12">
              <button
                class="btn btn-filter py-2 px-4 font-text1 fw-bold d-flex align-items-center justify-content-center w-100">
                <span class=""><img src="assets/images/apps/17.png" width="20" class="me-2"
            ...
            <div class="col-12 col-lg-12">
              <button
                class="btn btn-filter py-2 px-4 font-text1 fw-bold d-flex align-items-center justify-content-center w-100">
                <span class=""><img src="assets/images/apps/18.png" width="20" class="me-2"
