      ...
      <div class="card-header p-3">
        <div class="d-flex align-items-center gap-3">
          <div class="d-flex flex-row gap-3 align-items-center justify-content-center border p-3 rounded-3 flex-fill">
            <img src="https://placehold.co/200x200/png" width="40" height="40" class="rounded-circle" alt="">
            <div class="">
              <h5 class="mb-0">65%</h5>
              <p class="mb-0">Male</p>
            </div>
          </div>
          <div class="d-flex flex-row gap-2 align-items-center justify-content-center border p-3 rounded-3 flex-fill">
            <img src="https://placehold.co/200x200/png" width="40" height="40" class="rounded-circle" alt="">
            <div class="">
              <h5 class="mb-0">35%</h5>
