...
<div class="chat-wrapper">
  ...
  <div class="chat-content">
    <div class="chat-content-leftside">
      <div class="d-flex">
        <img src="https://placehold.co/110x110/png" width="48" height="48" class="rounded-circle" alt="" />
        <div class="flex-grow-1 ms-2">
    ...
    <div class="chat-content-rightside">
      <div class="d-flex">
        <div class="flex-grow-1 me-2">
          ...
          <p class="chat-right-msg">i purchased dashtreme admin template from themeforest. it is very good product for
            web application</p>
        </div>
      </div>
    </div>
